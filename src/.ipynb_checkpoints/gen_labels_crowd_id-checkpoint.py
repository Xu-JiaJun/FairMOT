...
if __name__ == '__main__':
    data_val = '/root/autodl-tmp/data/crowdhuman/images/val'
    label_val = '/root/autodl-tmp/data/crowdhuman/labels_with_ids/val'
    ann_val = '/root/autodl-tmp/data/crowdhuman/annotation_val.odgt'
    data_train = '/root/autodl-tmp/data/crowdhuman/images/train'
    label_train = '/root/autodl-tmp/data/crowdhuman/labels_with_ids/train'
    ann_train = '/root/autodl-tmp/data/crowdhuman/annotation_train.odgt'
